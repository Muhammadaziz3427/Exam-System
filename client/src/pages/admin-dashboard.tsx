...
import { 
  ...
  DropdownMenuTrigger,
  Skeleton
} from "@/components/ui-kit"; // UI-kit ichida Dropdown borligiga ishonch hosil qiling
...
import { format } from "date-fns"; // Sanalarni chiroyli qilish uchun (agar bo'lmasa oddiy string ishlatamiz)
    ...
    <AdminLayout>
      <div className="max-w-7xl mx-auto space-y-8 px-4 sm:px-6 lg:px-8 py-8 animate-in fade-in duration-500">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          {/* 3. ASOSIY JADVAL (LIVE MONITORING) */}
                ...
                <table className="w-full text-left">
                  <thead className="bg-slate-50/80 backdrop-blur sticky top-0 z-10 text-[10px] uppercase font-black tracking-widest text-slate-400">
                    <tr>
                      ...
                      <th className="px-8 py-4 text-right">Integrity / Score</th>
                    </tr>
                  </thead>
                          ...
                          <td className="px-8 py-5 text-right font-black text-blue-600 text-[10px]">
                            {['in_progress', 'active'].includes(session.status) ? (
                              ...
                              <span className="text-slate-500">
                                {session.score ? `${session.score} BALL` : 'YAKUNLANGAN'}
                              </span>
                            )}
                          </td>
                        </tr>
          ...
          {/* 4. O'NG TOMON PANEL (PANEL & SUPPORT) */}
          <div className="space-y-8">
            ...
            <Card className="bg-slate-900 text-white border-none shadow-2xl rounded-[2.5rem] relative overflow-hidden group">
               ...
               <CardContent className="space-y-8 text-center py-12 relative z-10">
                 ...
                 <div className="space-y-3">
                   ...
                   <p className="text-slate-400 text-sm px-6 font-medium">AI monitoring is currently active on {activeSessions.length} sessions.</p>
                 </div>
            ...
            <Card className="border-none shadow-xl rounded-[2.5rem] bg-gradient-to-br from-indigo-600 to-purple-800 text-white overflow-hidden relative">
               ...
               <CardContent className="p-8 space-y-4 relative z-10">
                 ...
                 <p className="text-xs text-indigo-100/80">Muammo yuzaga kelsa, dasturchilar bilan bog'laning.</p>
        ...
        <footer className="mt-12 py-6 text-center border-t border-slate-100">
          <p className="text-[10px] text-slate-400 font-medium tracking-widest uppercase">
            Control Center v2.0 • Powered by <span className="text-slate-900 font-bold">Gemini AI Engine</span>
          </p>
        </footer>
      </div>
    </AdminLayout>
