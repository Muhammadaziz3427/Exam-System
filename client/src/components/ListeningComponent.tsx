...
export function ListeningComponent({
  ...
  useEffect(() => {
    // Transfer time when audio ends (triggered from parent)
    if (isTransferring) {
        ...
        <div className="space-y-12 p-8 pb-32">
          {parts.map((part: any, pIdx: number) => (
            ...
            >
              ...
              {pIdx === 0 && (
                <div className="space-y-4">
                  <div className="border border-black p-6">
                    ...
                    {/* Question 1 */}
                    <div id={`q-container-${getGlobalQuestionNumber(pIdx, 0)}`}>
                    ...
                    {/* Question 2 */}
                    <div id={`q-container-${getGlobalQuestionNumber(pIdx, 1)}`}>
                      <p>
                    ...
                    {/* Question 3 */}
                    <div id={`q-container-${getGlobalQuestionNumber(pIdx, 2)}`}>
                      <p>
                    ...
                    {/* Question 4 */}
                    <div id={`q-container-${getGlobalQuestionNumber(pIdx, 3)}`}>
                      <p>
                    ...
                    {/* Question 5 */}
                    <div id={`q-container-${getGlobalQuestionNumber(pIdx, 4)}`}>
                      <p>
                    ...
                    {/* Question 6 */}
                    <div id={`q-container-${getGlobalQuestionNumber(pIdx, 5)}`}>
                      <p>
                    ...
                    {/* Question 7 */}
                    <div id={`q-container-${getGlobalQuestionNumber(pIdx, 6)}`}>
                      <p>
                    ...
                    {/* Question 8 */}
                    <div id={`q-container-${getGlobalQuestionNumber(pIdx, 7)}`}>
                      <p>
                        - a recent
                        <input
                          type="text"
                    ...
                    {/* Question 9 */}
                    <div id={`q-container-${getGlobalQuestionNumber(pIdx, 8)}`}>
                      <p>
                        Address: 707,
                        <input
                          type="text"
                    ...
                    {/* Question 10 */}
                    <div id={`q-container-${getGlobalQuestionNumber(pIdx, 9)}`}>
                      <p>
                        Contact email: music.
                        <input
                          type="text"
                ...
                <div className="space-y-8">
                  <div>
                    ...
                    <div className="space-y-4">
                      {part.questions?.slice(0, 4).map((q: any, qIdx: number) => {
                        ...
                        return (
                          <div key={qIdx} id={`q-container-${globalQNum}`} className="space-y-2">
                  ...
                  <div>
                    ...
                    {part.questions?.slice(4).map((q: any, qIdx: number) => {
                      ...
                      return (
                        <div key={qIdx} id={`q-container-${globalQNum}`} className="flex items-center gap-4 mb-2">
                          ...
                          return (
                            ...
                            >
                              ...
                              <div className="w-24 h-8 flex items-center justify-center bg-gray-50 border rounded">
                                {answers[qId] && (
                                  <span className="font-bold text-blue-600">{answers[qId]}</span>
                                )}
                              </div>
                            </div>
                          );
              ...
              {/* PART 4 – bullet list with inline inputs */}
              {pIdx === 3 && (
                <div className="space-y-4">
                  <div className="border border-black p-6">
                    ...
                    <ul className="list-none pl-5 space-y-2">
                      {/* Question 31 */}
                      <li id={`q-container-${getGlobalQuestionNumber(pIdx, 0)}`}>
                    ...
                    <ul className="list-none pl-5 space-y-2">
                      {/* Question 32 */}
                      <li id={`q-container-${getGlobalQuestionNumber(pIdx, 1)}`}>
                      ...
                      {/* Question 33 */}
                      <li id={`q-container-${getGlobalQuestionNumber(pIdx, 2)}`}>
                      ...
                      {/* Question 34 */}
                      <li id={`q-container-${getGlobalQuestionNumber(pIdx, 3)}`}>
                    ...
                    <ul className="list-none pl-5 space-y-2">
                      {/* Question 35 */}
                      <li id={`q-container-${getGlobalQuestionNumber(pIdx, 4)}`}>
                      ...
                      {/* Question 36 */}
                      <li id={`q-container-${getGlobalQuestionNumber(pIdx, 5)}`}>
                        • the seeds of the
                        <input
                          type="text"
                          className="answer-input"
                    ...
                    <ul className="list-none pl-5 space-y-2">
                      {/* Question 37 */}
                      <li id={`q-container-${getGlobalQuestionNumber(pIdx, 6)}`}>
                      ...
                      {/* Question 38 */}
                      <li id={`q-container-${getGlobalQuestionNumber(pIdx, 7)}`}>
                        • Watered with
                        <input
                          type="text"
                          className="answer-input"
                      ...
                      {/* Question 39 */}
                      <li id={`q-container-${getGlobalQuestionNumber(pIdx, 8)}`}>
                    ...
                    <ul className="list-none pl-5 space-y-2">
                      ...
                      {/* Question 40 */}
                      <li id={`q-container-${getGlobalQuestionNumber(pIdx, 9)}`}>
